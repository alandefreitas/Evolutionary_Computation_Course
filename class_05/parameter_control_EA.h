...
#ifndef EVOLUTIONARY_COMPUTATION_PARAMETER_CONTROL_EA_H
#define EVOLUTIONARY_COMPUTATION_PARAMETER_CONTROL_EA_H
...
public:
    ...
    public:
        ...
        void disp(problem &p) { this->s.disp(p); };
...
public:
    parameter_control_EA(problem &p);
...
#endif //EVOLUTIONARY_COMPUTATION_PARAMETER_CONTROL_EA_H
